...
/**
 * TELEMETRY & DATA PERSISTENCE SERVICE — v3.0
 * 
 * SECURITY NOTE:
 * ─────────────
 ...
 * To read analytics data, connect as the DB owner via a private server context.
 * Run scripts/schema.sql in your Neon SQL editor to apply RLS policies.
 */
...
export async function logTelemetryEvent(payload) {
  ...
  try {
    ...
    // Fail silently in production — telemetry errors should never break UX
 ...
 * Email validation is handled by lib/emailValidator.js before calling this.
 */
